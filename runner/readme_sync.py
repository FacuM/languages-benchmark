...
def _architecture_plot_lines(payload: dict, plot_rel_dir: Path, docs_dir: Path, prefix: str, comparison_label: str) -> list[str]:
    ...
    for architecture in architectures:
        ...
        sections.extend([
            ...
            "",
            f"![{architecture} service/UI startup ranked chart]({plot_rel_dir.as_posix()}/{plot_name('startup_units')}_ranked.svg)",
            "",
            f"![{architecture} service/UI workload ranked chart]({plot_rel_dir.as_posix()}/{plot_name('workload_units')}_ranked.svg)",
            "",
            ...
            "",
            f"![{architecture} service/UI startup canonical chart]({plot_rel_dir.as_posix()}/{plot_name('startup_units')}.svg)",
            "",
            f"![{architecture} service/UI workload canonical chart]({plot_rel_dir.as_posix()}/{plot_name('workload_units')}.svg)",
            "",
